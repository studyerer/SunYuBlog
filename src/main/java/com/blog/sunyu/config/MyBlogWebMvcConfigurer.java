...
import com.blog.sunyu.interceptor.AdminLoginInterceptor;
...
public class MyBlogWebMvcConfigurer implements WebMvcConfigurer {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        registry.addResourceHandler("/upload/**").addResourceLocations("file:" + com.blog.sunyu.config.Constants.FILE_UPLOAD_DIC);
    }
}
